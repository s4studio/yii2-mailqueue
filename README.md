...
```
php yii migrate/up --migrationPath=@vendor/s4studio/yii2-mailqueue/migrations/
```
...
While `s4studio\mailqueue\MailQueue` extends from `yii\swiftmailer\Mailer`, you can replace it with this extension by adding 
